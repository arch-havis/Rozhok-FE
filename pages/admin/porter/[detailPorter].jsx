...
const Index = () => {
    ...
    const getDetailPorters = async () => {
        try {
            const response = await axios.get(`https://altagp3.online/porter/${router.query.idPorter}`, {
                headers: {
    ...
    const getDataDashboard = async () => {
        try {
            const response = await axios.get(`https://altagp3.online/porter/${router.query.idPorter}/pendapatan`, {
                headers: {
                    Authorization: `Bearer ${Cookies.get("token")}`,
                },
            });
